...
# ==========================================
# MIXINS POUR OPTIMISER LA STRUCTURE
# ==========================================
...
# Si vous avez besoin de ces modèles, ils sont disponibles dans l'historique Git
...
# MODÈLES OBSOLÈTES SUPPRIMÉS :
# - Grammar : Modèle générique non utilisé (remplacé par TheoryContent)
...
# Ces fonctionnalités sont gérées par :
# - TheoryContent : pour le contenu théorique et grammatical
# - ContentLesson : pour organiser le contenu des leçons