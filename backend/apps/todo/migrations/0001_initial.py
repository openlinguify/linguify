    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('1_draft', 'Draft'), ('1_todo', 'To Do'), ('1_in_progress', 'In Progress'), ('1_done', 'Done'), ('1_canceled', 'Canceled')], default='1_todo', max_length=20)),
                ('priority', models.CharField(choices=[('0', 'Normal'), ('1', 'Starred')], default='0', max_length=1)),
                ...
                ('personal_stage_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tasks', to='todo.personalstagetype')),
