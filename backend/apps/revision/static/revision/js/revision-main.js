                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-2">
                        <div class="alert border-0 share-modal-alert">
                            <div class="d-flex align-items-start">
                                <i class="bi bi-exclamation-triangle-fill me-2 mt-1" style="color: var(--linguify-warning);"></i>
                                <div>
                        ...
                        <div class="mb-3">
                            <h6 class="fw-semibold mb-2 share-modal-section-title">
                                <i class="bi bi-eye-slash me-1" style="color: var(--linguify-warning);"></i>
                                Ce qui va changer :
                            </h6>
                            <ul class="list-unstyled ms-3">
                                <li class="mb-1 share-modal-list-item">
                                    <i class="bi bi-x-circle me-2" style="color: var(--linguify-error);"></i>
                    ...
                    <div class="modal-footer border-0 pt-0">
                        ...
                        <button type="button" class="btn" id="makeDeckPrivateBtn" style="background: linear-gradient(135deg, var(--linguify-gray-light) 0%, var(--linguify-gray) 100%); border: none; color: white; font-weight: 500;">
