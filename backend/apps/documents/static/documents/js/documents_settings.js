...
const documentsSettings = window.documentsSettings || {
    ...
    save: function() {
        ...
        if (!settings) {
            this.showNotification('Erreur lors de la collecte des param�tres', 'error');
            return;
        }
        ...
        .catch(error => {
            ...
            localStorage.setItem('documentsSettings', JSON.stringify(settings));
            this.showNotification('Param�tres sauvegard�s localement', 'warning');
        });
    },
    ...
    reset: function() {
        if (!confirm('�tes-vous s�r de vouloir r�initialiser tous les param�tres aux valeurs par d�faut ?')) {
            return;
        }
        ...
        if (resetBtn) {
            ...
            resetBtn.innerHTML = '<i class="bi bi-hourglass-split me-2"></i>R�initialisation...';
        ...
        .catch(error => {
            ...
            this.applyDefaults();
            localStorage.removeItem('documentsSettings');
            this.showNotification('Param�tres r�initialis�s localement', 'warning');
        });
    },
    ...
    exportSettings: function() {
        ...
        this.showNotification('Param�tres export�s', 'success');
    },
    ...
    importSettings: function(file) {
        ...
        reader.onload = (e) => {
            try {
                ...
                this.showNotification('Erreur lors de l\'import des param�tres', 'error');
