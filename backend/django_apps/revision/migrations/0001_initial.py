    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vocabulary', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.vocabulary')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='revision',
            index=models.Index(fields=['word'], name='revision_re_word_f0763d_idx'),
        ),
        migrations.AddIndex(
            model_name='revision',
            index=models.Index(fields=['translation'], name='revision_re_transla_cad9e9_idx'),
        ),
        migrations.AddIndex(
