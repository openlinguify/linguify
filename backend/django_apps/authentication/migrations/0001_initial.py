    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_language', models.CharField(choices=[('EN', 'English'), ('FR', 'French'), ('NL', 'Dutch'), ('DE', 'German'), ('ES', 'Spanish'), ('IT', 'Italian'), ('PT', 'Portuguese')], default='EN', help_text='The language you are learning', max_length=20)),
