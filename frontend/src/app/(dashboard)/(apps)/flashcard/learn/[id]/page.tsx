...
export default function LearnPage() {
  ...
  if (currentIndex >= questions.length && questions.length > 0) {
    ...
    return (
      <div className="container mx-auto py-8 max-w-2xl">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold">Learning Complete!</h1>
          <Button variant="outline" onClick={backToDeck}>
            <ChevronLeft className="mr-2 h-4 w-4" /> Back to Decks
          </Button>
        </div>
              ...
              <div className="flex items-center">
                {isCorrect ? (
                  ...
                  <>
                    ...
                    <span className="font-medium text-red-600">Incorrect. The correct answer is: {currentQuestion.correctAnswer}</span>
                  </>
                )}
              </div>
            </div>
