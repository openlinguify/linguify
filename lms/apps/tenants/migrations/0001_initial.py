# Generated by Django 5.0.3 on 2025-07-05 23:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Owner'), ('admin', 'Administrator'), ('instructor', 'Instructor'), ('student', 'Student')], max_length=20)),
        ...
        migrations.AddField(
            ...
            name='organizations',
            field=models.ManyToManyField(related_name='users', through='tenants.OrganizationMembership', to='tenants.organization'),
        ),
    ]
