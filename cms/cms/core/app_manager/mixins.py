...
class SettingsContextMixin:
    ...
    def _build_settings_urls(self):
        ...
        settings_urls = {}
        url_mappings = {
            'profile': 'dashboard:profile_settings',
            'interface': 'dashboard:interface_settings',
            'learning': 'dashboard:learning_settings',
            'chat': 'dashboard:chat_settings',
            'community': 'dashboard:community_settings',
            'notebook': 'dashboard:notebook_settings',
            'notes': 'dashboard:notebook_settings',
            'quiz': 'dashboard:quiz_settings',
            'quizz': 'dashboard:quiz_settings',
            'revision': 'dashboard:revision_settings',
            'language_ai': 'dashboard:language_ai_settings',
            'language-ai': 'dashboard:language_ai_settings',
            'notifications': 'dashboard:notification_settings',
            'notification': 'dashboard:notification_settings',
            'documents': 'dashboard:documents_settings',
            'app_manager': 'dashboard:app_manager_settings',
            'language_learning': 'dashboard:language_learning_settings',
            'todo': 'dashboard:todo_settings',
        }
