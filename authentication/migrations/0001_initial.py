    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_id', models.ForeignKey(default='A1', on_delete=django.db.models.deletion.CASCADE, related_name='user_language_id', to='authentication.language')),
                ('learning_language', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='user_learning_language', to='authentication.language')),
                ('mother_language', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='user_mother_language', to='authentication.language')),
