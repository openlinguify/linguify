        ...
        return [
            {
                ...
                'summary': 'Organisez vos tâches et boostez votre productivité avec une gestion intelligente des tâches',
                'description': 'Gérez efficacement vos tâches avec notre système de todo intelligent incluant priorités, catégories et suivi de progression.',
                'icon': 'todo',
                'route': '/todo/',
                'menu_order': 0,
                'version': '1.0.0',
